...
const translations = {
  en: {
    company: "TRS Rides ",
    description:
      "Reliable 24/7 car rental, logistics, and chauffeur services across Poland.",
    contact: "Contact Us",
  ...
  pl: {
    company: "TRS Rides ",
    description:
      "Niezawodne usługi wynajmu samochodów, logistyki i szofera 24/7 w całej Polsce.",
  ...
  return (
    <header className=" bg-gray-900 text-white py-4 border-b border-gray-700">
      <div className="container w-full mx-auto flex flex-col md:flex-row justify-between items-center lg:gap-8">
        ...
        <a
          href={`tel:${t.phone}`}
          className="flex items-center gap-2 text-sm md:text-base lg:text-lg text-blue-400 hover:text-blue-300"
        >
    ...
    <footer className="w-full bg-gray-900 text-white">
      ...
      <div className="container mx-auto justify-center px-4 py-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 border-b border-gray-700">
        <div className="flex justify-center md:justify-center items-center gap-3 sm:gap-4">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-1 text-center sm:text-left">
              ADDRESS
            </h3>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center md:text-left">
          {/* About Section */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-white  pb-2">
              {t.about}
            </h3>
            <div className="flex justify-center md:justify-start">
              <img
                src="/logo.jpg"
                alt="TRS Rides"
                className="w-28 h-28 sm:w-32 sm:h-32 mb-4"
              />
            </div>
      ...
      <div className="border-t border-gray-700">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} TRS Rides. All rights reserved.
          </p>
