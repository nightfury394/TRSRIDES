...
import { logisticsServiceTranslations } from "@/app/translations/logistics-service"
import { logisticsServices } from "@/app/data/logistics-services"

export default function LogisticsServicePage() {
  const params = useParams()
  const language = useSelector((state: RootState) => state.language.current)
  const t = logisticsServiceTranslations[language]

  const service = logisticsServices.find((s) => s.id === params.id)
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Button size="lg" variant="outline" className="border-white  hover:bg-gray-900  text-gray-900 hover:text-white">
